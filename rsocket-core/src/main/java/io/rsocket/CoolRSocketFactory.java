...
public class CoolRSocketFactory extends RSocketFactory {
  ...
  public static class CoolClientRSocketFactory extends ClientRSocketFactory
      implements Leasing<CoolClientRSocketFactory> {
  ...
  public static class CoolRSocketServerFactory extends ServerRSocketFactory
      implements Leasing<CoolRSocketServerFactory> {
